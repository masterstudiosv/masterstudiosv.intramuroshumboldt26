...
/* ─── Guard: CONFIG debe existir ────────────── */
(function() {
  if (typeof CONFIG === 'undefined') {
    document.body.innerHTML = '<div style="display:flex;align-items:center;justify-content:center;height:100vh;background:#0a0a0a;color:#fff;font-family:sans-serif;flex-direction:column;gap:16px"><div style="font-size:48px">⚙️</div><div style="font-size:20px;font-weight:700">Configuración faltante</div><div style="color:#888;font-size:14px;text-align:center;max-width:400px">El archivo <code style="background:#1a1a1a;padding:2px 8px;border-radius:4px">js/config.js</code> no se encontró.<br>Verifica que esté desplegado en el servidor.</div></div>';
    throw new Error('CONFIG no definido — js/config.js no cargó');
  }
})();
